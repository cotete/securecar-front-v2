    ...
    return (
        <div className={clicado ? `flex w-screen h-screen flex-col items-end px-8` : ""}>
            ...
            <div className="flex w-full flex-col justify-center items-end">
                <Link className={clicado ? `static flex text-xl text-white hover:text-black mx-3 font-medium w-max gap-4 items-center py-4` : "hidden"} href={login ? "/conta" : '/login'}>Seu perfil<Image src="/icons/profile-pic.svg" alt="Imagem de perfil" className="h-[30px] hover:scale-110 transition" height={40} width={40}></Image></Link>
