...
const FormRegistro = ({ onSubmit }: FormRegistroProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (inputSenhaAux === inputSenha && verificaEmail(inputEmail) && inputCEP.length === 8 && inputCPF.length === 14) {
      ...
      await onSubmit(inputNome, inputSenha, inputCPF, inputNascimento, contato, endereco, inputRg, inputGenero);
