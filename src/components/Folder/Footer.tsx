...
const Footer = () => {
  ...
  return (
    <div className="celular:px-4 celular:py-10 w-full static bg-primary bottom-0 p-20 flex flex-col ">
      ...
      <Link href="/faq" className="w-full flex justify-center"><button className="bg-[#0081fe] py-5 px-11 rounded-custom-xl text-white text-[16px] w-max self-center my-5 hover:scale-110 transition-all duration-500 shadow-sm hover:bg-white hover:text-[#0081fe] ">Fale Conosco</button></Link>
